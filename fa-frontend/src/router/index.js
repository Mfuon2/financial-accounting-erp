...
export const routes = [
  ...
  { path: '/forgot-password',  component: () => import('@/views/auth/ForgotPassword.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: '/budgets',     component: () => import('@/views/planning/Budgets.vue') },
      { path: '/expense-claims', component: () => import('@/views/expenses/ExpenseClaims.vue') },
      { path: '/bank-reconciliation', component: () => import('@/views/banking/BankReconciliation.vue') },
...
export const CRUMBS = {
  ...
  '/expense-claims': ['Expenses', 'Expense Claims'],
