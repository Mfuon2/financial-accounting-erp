...
async function exportPdf() {
  try {
    await reports.pdfBalanceSheet({}, 'balance-sheet.pdf')
...
<template>
  <div class="page">
    <PageHeader title="Statement of Financial Position" :meta="`As at ${BS.asOf}`">
      <template #default>
    ...
    <div class="page-section">
      <div class="statement">
        <div class="statement-head">
          ...
          <div class="e-period">As at {{ BS.asOf }}</div>
        </div>
        ...
        <StRow v-for="(r, i) in BS.sections" :key="i" v-bind="r" />
