...
async function exportPdf() {
  try {
    await reports.pdfPnl({}, 'profit-loss.pdf')
...
<template>
  <div class="page">
    <PageHeader title="Statement of Profit & Loss" :meta="PnL.period">
      <template #default>
    ...
    <div class="page-section">
      <div class="statement">
        <div class="statement-head">
          ...
          <div class="e-period">{{ PnL.period }}</div>
        </div>
        ...
        <StRow v-for="(r, i) in PnL.sections" :key="i" v-bind="r" />
